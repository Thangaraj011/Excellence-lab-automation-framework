...
- Name: authentication-validation.spec.js >> User Login Successful Tests >> Manager Direct Login Homepage validation
- Location: tests/specs/authentication-validation.spec.js:28:3
