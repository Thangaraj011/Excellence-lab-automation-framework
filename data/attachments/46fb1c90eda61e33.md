...
```ts
  ...
  65 |         try {
  66 |             const raw = fs.readFileSync(filePath, "utf-8");
  67 |             console.log("*********************************");
  68 |             console.log(`Loaded test data from: ${filePath}`);
  69 |             console.log(JSON.parse(raw));
