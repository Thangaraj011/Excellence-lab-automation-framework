...
- Name: authentication-validation.spec.js >> User Login Successful Tests >> Employee Login Homepage validation
- Location: tests/specs/authentication-validation.spec.js:6:3
