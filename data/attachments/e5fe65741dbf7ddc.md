...
- Location: tests/specs/authentication-validation.spec.js:18:3
...
> 25 |     await expect(contextSetup.poManager.homePage.profileName).toHaveText('Tarun Sareen');
  ...
  49 |     await expect(contextSetup.poManager.homePage.profileName).toHaveText('Janakjit Singh Sethi');
  ...
  62 |     await expect(contextSetup.poManager.homePage.profileName).toHaveText('Sameer Kumar');
