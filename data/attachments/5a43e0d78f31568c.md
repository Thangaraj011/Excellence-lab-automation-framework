...
- Name: homepage-Individual-content-with-fixtures.spec.js >> Homepage Individual Content status update validation with custom Fixtures >> Individual Content update status to Complete with custom fixtures
- Location: tests/specs/homepage-Individual-content-with-fixtures.spec.js:40:3

# Error details

```
TypeError: testContext.poManager.homePage is not a function
```
