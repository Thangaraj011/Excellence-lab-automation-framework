...
```
ReferenceError: skillCategoryValue is not defined
```
...
```ts
  34  |     this.assignedTooltip = page.getByRole('tooltip', { name: 'Mark as in progress' });
  35  |     this.inProgressTooltip = page.getByRole('tooltip', { name: 'Mark complete' });
