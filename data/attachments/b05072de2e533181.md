...
- Name: homepage/homepage-Individual-content.spec.js >> Homepage Individual Content Status Update Validation >> Individual Content update status to Complete
- Location: tests/specs/homepage/homepage-Individual-content.spec.js:39:8
...
Call log:
  - waiting for getByText('The Art of Active Listening | The Harvard Business Review Guide', { exact: true })
...
```ts
  ...
  62  |       `//span[normalize-space()='Assigned By Manager']/ancestor::div[contains(@class,'ant-card')][1]/following-sibling::div[contains(@class,'ant-card-body')]//div[contains(@class,'_listHeadingWrap_')]`,
  63  |     );
  64  |     this.adminAssignedContentTitles = page.locator(
  65  |       `//span[normalize-space()='Assigned By Admin']/ancestor::div[contains(@class,'ant-card')][1]/following-sibling::div[contains(@class,'ant-card-body')]//div[contains(@class,'_listHeadingWrap_')]`,
  66  |     );
  67  | 
