...
Call log:
  - waiting for locator('div').filter({ hasText: 'Marked as completed' }).first() to be visible
  ...
  - generic [ref=e4]:
    ...
    - main [ref=e140]:
      - generic [ref=e145]:
        ...
        - generic [ref=e157]:
          - progressbar "Learning path completion 44 percent" [ref=e159]
          - strong [ref=e164]: 44%
        - separator [ref=e165]
          ...
          - generic [ref=e403] [cursor=pointer]:
            - generic [ref=e404]:
              ...
              - generic [ref=e410]:
                ...
                - img "Completed" [ref=e417]:
                  - img "check-circle" [ref=e418]:
                    - img [ref=e419]
            - generic [ref=e423]:
              - generic [ref=e425]: Introduction to loading data into BigQuery
              - generic [ref=e427]:
                - generic [ref=e428]:
                  - generic [ref=e430]: Data Engineering
                  - generic [ref=e432]: Cloud BigQuery
                - separator [ref=e433]
                - generic [ref=e434]:
                  - generic [ref=e435]: Mandatory
                  - generic [ref=e436]: Assigned by Admin
          - generic [ref=e439] [cursor=pointer]:
            - generic [ref=e440]:
              - generic [ref=e442]:
                - generic [ref=e443]: Due
                - generic [ref=e444]: N/A
              - generic [ref=e446]:
                - status "Individual Content" [ref=e447]:
                  - img [ref=e448]:
                    - img [ref=e449]
                  - generic [ref=e451]: Individual Content
                - button "In progress, mark complete" [disabled] [ref=e453]:
                  - generic:
                    - img "loading":
                      - img
            - generic [ref=e454]:
      ...
      - generic [ref=e751]:
        ...
        - generic [ref=e760]:
          - img "exclamation-circle" [ref=e761]:
            - img [ref=e762]
          - generic [ref=e765]:
            - generic [ref=e766]: Streaming Data into BigQuery
            - generic [ref=e767]: This will mark the course as COMPLETED.
        - generic [ref=e768]:
          - button "Cancel" [ref=e769] [cursor=pointer]:
            - generic [ref=e770]: Cancel
          - button "loading Yes, mark complete" [active] [ref=e771]:
            - img "loading" [ref=e773]:
              - img [ref=e774]
            - generic [ref=e776]: Yes, mark complete
```
...
> 122 |     await this.markCompleteToast.waitFor({ state: "visible", timeout: 8000 });
  ...
  126 |     await expect(this.page.getByText("Confirm completion").last()).toBeVisible();
  127 |     await expect(
