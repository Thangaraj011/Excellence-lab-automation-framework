...
```ts
  ...
  14 |     }, token);
> 15 |     const newTab = await context.newPage();
     |                                  ^ TypeError: context.newPage is not a function
