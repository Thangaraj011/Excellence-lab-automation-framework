...
Error: strict mode violation: getByText('Confirm completion') resolved to 2 elements:
    1) <div id="_r_sr_" class="ant-modal-title">Confirm completion</div> aka locator('[id="_r_sr_"]')
    2) <div id="_r_su_" class="ant-modal-title">Confirm completion</div> aka locator('[id="_r_su_"]')
...
- generic [ref=e1]:
  ...
  - generic [ref=e749]: "0"
  - tooltip "Mark complete" [ref=e751]
  - generic [ref=e752]:
    - dialog "Confirm completion":
      - generic [ref=e753]:
        - button "Close" [ref=e754] [cursor=pointer]:
          - generic "Close" [ref=e755]:
            - img "close" [ref=e756]:
              - img [ref=e757]
        - generic [ref=e760]: Confirm completion
        - generic [ref=e762]:
          - img "exclamation-circle" [ref=e763]:
            - img [ref=e764]
          - generic [ref=e767]:
            - generic [ref=e768]: Create IAM Roles and Service Accounts
            - generic [ref=e769]: This will mark the course as COMPLETED.
        - generic [ref=e770]:
          - button "Cancel" [ref=e771] [cursor=pointer]:
            - generic [ref=e772]: Cancel
          - button "Yes, mark complete" [ref=e773] [cursor=pointer]:
            - generic [ref=e774]: Yes, mark complete
```
