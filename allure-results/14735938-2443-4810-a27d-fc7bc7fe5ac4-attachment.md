...
```ts
  ...
  64 |         const filePath = path.resolve(__dirname, "../data", this.testInfo.file.replace(/\.spec\.(js|ts)$/, ".json"));
  65 |         console.log(`filePath: ${filePath}`);
  66 |         try {
