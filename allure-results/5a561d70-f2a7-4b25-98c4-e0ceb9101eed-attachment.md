...
> 14 |     contextSetup.genericUtils.generateJWT(process.env.EMP_USERNAME);
     |                               ^ TypeError: contextSetup.genericUtils.generateJWT is not a function
  15 |     page.goto(`${process.env.BASE_FE_URL}`);
  16 |     await page.pause();
  17 |   });
  18 | 
  19 | 
