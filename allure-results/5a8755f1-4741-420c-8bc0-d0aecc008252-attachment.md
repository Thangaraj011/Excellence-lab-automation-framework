...
```ts
  ...
  141 |       console.log(apiContentTitlesRetrieved);
  142 |       const uiContentTitlesDisplayed = await homePage.getContentNames();
  143 |       console.log(uiContentTitlesDisplayed);
> 144 |       expect(apiContentTitlesRetrieved).toEqual(uiContentTitlesDisplayed);
      |                                         ^ Error: expect(received).toEqual(expected) // deep equality
  145 |     },
  146 |   );
  147 | });
